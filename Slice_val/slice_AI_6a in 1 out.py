...
model_path = '../model/Transformer_best_model_117.pth'
output_path = '../output/AIData_ALL_model_117_6a_1.csv'

feature_columns = ['Tube Diameter' ,'Heated Length', 'Enthalpy value of water', 'Enthalpy value of air' , 'Mass Flux', 'Inlet Subcooling' ,'Inlet Temperature']
