...
model_path = '../model/Transformer_best_model_118.pth'
output_path = '../output/AIData_ALL_model_118_6b_1.csv'

feature_columns = ['Tube Diameter' ,'Heated Length', 'Enthalpy value of water', 'Enthalpy value of air' , 'Enthalpy Temperature','Mass Flux', 'Inlet Subcooling']
