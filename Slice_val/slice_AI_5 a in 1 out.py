...
sheet_name = 'slice02'
input_path = '../input/'
model_path = '../model/Transformer_best_model_114.pth'
out_path = '../output/AIData_ALL_model_114_5a_1.csv'

feature_columns = ['Tube Diameter', 'Heated Length' ,'Enthalpy value of air', 'Mass Flux', 'Inlet Subcooling']
