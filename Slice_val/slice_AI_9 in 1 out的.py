...
model_path = '../model/Transformer_best_model_116.pth'
output_path = '../output/AIData_ALL_model_116_9_1.csv'

feature_columns = ['Tube Diameter' ,'Heated Length', 'Enthalpy value of water', 'Enthalpy value of air' ,'Enthalpy Temperature','Pressure', 'Mass Flux', 'Inlet Subcooling' ,'Inlet Temperature']
