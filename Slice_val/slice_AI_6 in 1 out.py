...
data_to_transform = data_to_transform.drop(['Pressure'], axis=1)

data_to_transform = data_to_transform.reindex(columns=['Tube Diameter', 'Heated Length', 'Enthalpy value of water', 'Enthalpy value of air' , 'Mass Flux', 'Inlet Subcooling'])
...
normalized_slice_data_2d =  data_to_transform[['Tube Diameter', 'Heated Length', 'Enthalpy value of water', 'Enthalpy value of air' , 'Mass Flux', 'Inlet Subcooling',]].values
...
slice_real_data_values = slice_real_data[['Tube Diameter', 'Heated Length', 'Enthalpy value of water', 'Enthalpy value of air' , 'Mass Flux', 'Inlet Subcooling',]].values
...
# 加载保存的模型权重
pth = torch.load('../model/Transformer_best_model_110.pth',map_location=device)
...
data = readDataIfExist(public_sheet_name)
data['AI CHF'] = outX
data.to_csv('../output/AIData_ALL1.csv', index=False)
