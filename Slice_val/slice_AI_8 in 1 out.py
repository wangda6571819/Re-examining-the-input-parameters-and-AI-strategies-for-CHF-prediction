...
model_path = '../model/Transformer_best_model_115.pth'
output_path = '../output/AIData_ALL_model_115_8_1.csv'

feature_columns = ['Tube Diameter' ,'Heated Length', 'Enthalpy value of water', 'Enthalpy value of air' ,'Enthalpy Temperature', 'Mass Flux', 'Inlet Subcooling' ,'Inlet Temperature']
