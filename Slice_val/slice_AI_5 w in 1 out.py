...
sheet_name = 'slice02'
input_path = '../input/'
model_path = '../model/Transformer_best_model_113.pth'
out_path = '../output/AIData_ALL_model_111_5w_1.csv'

feature_columns = ['Tube Diameter', 'Heated Length' ,'Enthalpy value of water', 'Mass Flux', 'Inlet Subcooling']
