...
file_path = '../data/Data_CHF_Zhou_no_filter.csv'
...
base_model_path = '../Transfer_model/Transfer_with_freeze_train_tube.pth'
new_model_path = '../Transfer_model/Transformer_best_model_107.pth'
