...
class MambaModel(nn.Module):
    def __init__(self, input_features, d_model, nhead, num_encoder_layers, dim_feedforward, dropout):
        ...
        self.mamba_model = Mamba(MambaConfig(d_model = d_model, n_layers=input_features))
...
def doTrain(feature_columns = ['Tube Diameter' ,'Heated Length', 'Enthalpy value of water', 'Enthalpy value of air' , 'Enthalpy Temperature','Mass Flux', 'Inlet Subcooling'],epochsCount = 100, callIndex = 'findBest' , model_name = 'Mamba') :
    ...
    model = MambaModel(input_features=input_size, d_model=d_model, nhead=nhead, num_encoder_layers=num_encoder_layers,dim_feedforward=dim_feedforward, dropout=dropout)
...
if __name__ == "__main__":
    ...
    doTrain(epochsCount = epochsCount, feature_columns = ['Tube Diameter', 'Heated Length', 'Enthalpy value of water','Enthalpy value of air' , 'Mass Flux', 'Inlet Subcooling'], callIndex = '200')
