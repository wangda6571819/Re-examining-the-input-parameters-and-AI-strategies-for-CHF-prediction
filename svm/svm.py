...
# Store the results for the simplified ε-SVM
svm_results_simplified = {
    'Group 1': {'RMSPE Test': rmspe_test_1_svm_simplified, 'MAPE Test': mape_test_1_svm_simplified, 'NRMSE Test': nrmse_test_1_svm_simplified, '1-Q² Test': q2_test_1_svm_simplified, 'OD Test': od_test_1_svm_simplified,
                'RMSPE Full': rmspe_full_1_svm_simplified, 'MAPE Full': mape_full_1_svm_simplified, 'NRMSE Full': nrmse_full_1_svm_simplified, '1-Q² Full': q2_full_1_svm_simplified, 'OD Full': od_full_1_svm_simplified},
    'Group 2': {'RMSPE Test': rmspe_test_2_svm_simplified, 'MAPE Test': mape_test_2_svm_simplified, 'NRMSE Test': nrmse_test_2_svm_simplified, '1-Q² Test': q2_test_2_svm_simplified, 'OD Test': od_test_2_svm_simplified,
                'RMSPE Full': rmspe_full_2_svm_simplified, 'MAPE Full': mape_full_2_svm_simplified, 'NRMSE Full': nrmse_full_2_svm_simplified, '1-Q² Full': q2_full_2_svm_simplified, 'OD Full': od_full_2_svm_simplified}
}
...
for slice_name in slice_sheet_name :
    ...
    print(prData)
    predictData = svm_model_simplified.predict(prData)
    print(predictData)
